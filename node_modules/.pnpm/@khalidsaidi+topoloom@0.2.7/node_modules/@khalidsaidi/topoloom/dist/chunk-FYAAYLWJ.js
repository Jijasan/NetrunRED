...
__export(order_exports, {
  bipolarOrientation: () => bipolarOrientation,
  stNumbering: () => stNumbering,
  validateStNumbering: () => validateStNumbering
});
function validateStNumbering(graph, s, t, numbering) {
  ...
  for (let v = 0; v < n; v += 1) {
    ...
    for (const adj of graph.adjacency(v)) {
      ...
      if (wNum !== void 0 && num !== void 0 && wNum < num) hasLower = true;
      if (wNum !== void 0 && num !== void 0 && wNum > num) hasHigher = true;
    }
...
function stNumbering(graph, s, t) {
  const n = graph.vertexCount();
...
function bipolarOrientation(mesh, s, t) {
...
export { bipolarOrientation, order_exports, stNumbering, validateStNumbering };
//# sourceMappingURL=chunk-FYAAYLWJ.js.map
//# sourceMappingURL=chunk-FYAAYLWJ.js.map